...
app.get('/getHopital', (req: Request, res: Response) => {
...
app.get('/getPersonne', (req: Request, res: Response) => {
...
app.get('/getPersonnel', (req: Request, res: Response) => {
...
app.get('/getMedecin', (req: Request, res: Response) => {
...
app.get('/getInfirmier', (req: Request, res: Response) => {
...
app.get('/getAgentEntretient', (req: Request, res: Response) => {
...
app.get('/getAdministratif', (req: Request, res: Response) => {
...
app.get('/getPatient', (req: Request, res: Response) => {
...
app.get('/getVisiteMedicale', (req: Request, res: Response) => {
...
app.get('/getMedicament', (req: Request, res: Response) => {
...
app.get('/getSoin', (req: Request, res: Response) => {
...
app.get('/getOrdonnance', (req: Request, res: Response) => {
...
app.get('/getReunion', (req: Request, res: Response) => {
...
app.get('/getCompteRendu', (req: Request, res: Response) => {
...
app.get('/getParticipant_Reunion', (req: Request, res: Response) => {
...
app.get('/getService', (req: Request, res: Response) => {
...
app.get('/getEtage', (req: Request, res: Response) => {
...
app.get('/getChambre', (req: Request, res: Response) => {
...
app.get('/getLit', (req: Request, res: Response) => {
